...
export class ContactsRepository implements IContactRepository {
    ...
    getContacts(): Observable<IHttpBasicResponse<Array<IContactApiProps>>> {
        //const token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjQiLCJjbGllbnRfaWQiOiIyIiwibmFtZSI6IlZpcmtldCBUZXN0IiwiZW1haWwiOiJhdmJAdmlya2V0LmNvbSIsInJvbGVfaWQiOiIzIiwiYXV0aGVkX2F0IjoiMjAyMC0wNi0wOCAxMToxMToxNyJ9.rL3KraHg6vZRPwvR9qNSv5j2D5mW5kV7H6hltptAXls";
...
export const COUNTRY_CALLING_CODES = [
    ...
    { alpha3Code: 'MEX', callingCodes: ['52'], "flag": "https://restcountries.eu/data/mex.svg", name: "México", translations: { es: 'México' } },
